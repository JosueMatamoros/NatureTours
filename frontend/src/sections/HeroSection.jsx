  ...
  return (
    <section
      className="
        ...
        bg-[url('/hero/rioHorse.jpg')] bg-cover bg-[center_15%]
        md:bg-[url('/hero/tourGroup.jpg')] md:bg-cover md:bg-[center_20%]
      "
    >
      ...
      <div className="hidden md:block absolute inset-0 z-10" style={{
        background: "linear-gradient(to bottom, rgba(0,0,0,0.72) 0%, rgba(0,0,0,0.2) 38%, rgba(0,0,0,0.2) 62%, rgba(0,0,0,0.82) 100%)"
      }} />
      <div className="hidden md:block absolute inset-0 z-10" style={{
      ...
      {/* TABLET / DESKTOP layout: centered */}
      <div className="hidden md:flex absolute inset-0 items-center justify-center z-20">
        <div className="text-center max-w-3xl px-4">
          <p className="inline-flex items-center gap-2 rounded-full bg-white/10 px-5 py-2 text-xs font-medium tracking-wide text-white/90 backdrop-blur-md border border-white/20 shadow-[0_4px_20px_rgba(0,0,0,0.35)] mb-4 mt-8">
            <HiOutlineSparkles className="h-4 w-4" />
            Eco tours • Wildlife • Adventure
          </p>

          <h1 className="text-7xl lg:text-8xl font-black text-white tracking-tight">
